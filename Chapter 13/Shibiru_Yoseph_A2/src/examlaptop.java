...
public class examlaptop implements Comparable <Laptop>{
...
//life (hours), and price
    ...
    public void Laptop(double cpu, double ram, double hdd, double screenSize, double weight, double batteryLife, double price, int graphicsCard) {
        this.cpu = cpu;
        this.ram = ram;
        this.hdd = hdd;
